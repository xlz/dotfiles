...
globalkeys = awful.util.table.join(
    awful.key({ modkey,           }, "Left",   focusdir("left")         ),
    awful.key({ modkey,           }, "Right",  focusdir("right")        ),
    awful.key({ modkey,           }, "Up",     focusdir("up")           ),
    awful.key({ modkey,           }, "Down",   focusdir("down")         ),
    ...
    awful.key({ modkey,           }, "b", function () awful.util.spawn("/bin/sh -c 'exec x-www-browser --proxy-pac-url=file://" .. awful.util.getdir("config") .. "/proxy.js 2>/dev/null'") end),
